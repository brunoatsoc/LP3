...
public class Time{
    ...
    public static int diffTime(Time t1, Time t2){
        return (mode(t1.getHour() - t2.getHour()) * 60 * 60) + (mode(t1.getMinute() - t2.getMinute()) * 60) + mode(t1.getSecond() - t2.getSecond());
    }

    public static int diffTime(Time t){
        setHoraComputador();
        return (mode(t.getHour() - horaComp) * 60 * 60) + (mode(t.getMinute() - minComp) * 60) + mode(t.getSecond() - segComp);
    }
